...
// uniforms
uniform isampler2D rgb_Texture;
...
float texture_bilinear_red(in isampler2D t, in vec2 uv, in vec2 textureSize, in vec2 texelSize, float rangeX, float rangeY)
{
...
float texture_bilinear_green(in isampler2D t, in vec2 uv, in vec2 textureSize, in vec2 texelSize, float rangeX, float rangeY)
{
...
float texture_bilinear_blue(in isampler2D t, in vec2 uv, in vec2 textureSize, in vec2 texelSize, float rangeX, float rangeY)
{
