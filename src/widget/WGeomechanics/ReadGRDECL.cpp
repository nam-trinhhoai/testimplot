...
ReadGRDECL::ReadGRDECL(QWidget *parent)
{
	this->setWindowTitle("GRDECL Mesh Format");
...
ReadGRDECL::~ReadGRDECL()
{
}

void ReadGRDECL::convert_mesh()
{	
...
void ReadGRDECL::load_input_mesh()
{
...
void ReadGRDECL::load_file_to_qtextedit(QString const fileName, QTextEdit *qte)
{
	QFile file(fileName);
...
void ReadGRDECL::save_converted_mesh()
{
...
void ReadGRDECL::save_qtextedit_to_file(QString const fileName, QTextEdit *qte)
{
	QFile file(fileName);
...
void ReadGRDECL::view_converted_mesh()
{
