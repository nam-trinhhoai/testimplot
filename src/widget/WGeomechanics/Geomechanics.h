...
#ifndef NEXTVISION_SRC_WIDGET_WGEOMECHANICS_GEOMECHANICS_H_
#define NEXTVISION_SRC_WIDGET_WGEOMECHANICS_GEOMECHANICS_H_
...
class Geomechanics : public QWidget
{
	Q_OBJECT

public:
    Geomechanics(QWidget *parent=nullptr);
    virtual ~Geomechanics();
...
#endif /* NEXTVISION_SRC_WIDGET_WGEOMECHANICS_GEOMECHANICS_H_ */
