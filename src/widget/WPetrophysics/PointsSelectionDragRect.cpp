...
PointsSelectionDragRect::PointsSelectionDragRect(WorkingSetManager* manager):
m_manager(manager)
{}

PointsSelectionDragRect::~PointsSelectionDragRect()
{}

// Cross-plot between the logs
void PointsSelectionDragRect::showPlot() {
	// Selected data
