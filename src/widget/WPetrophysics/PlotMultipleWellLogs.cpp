...
PlotMultipleWellLogs::PlotMultipleWellLogs(WorkingSetManager* manager):
m_manager(manager)
{}

PlotMultipleWellLogs::~PlotMultipleWellLogs()
{}

// Interactive helper		
int PlotMultipleWellLogs::interactiveHelper(Logs log)
{
...
void PlotMultipleWellLogs::longCrossHairCursor()
{
	/*
	int x, y;
	Uint32 buttons;
...
// Drag and drop to plot a log
void PlotMultipleWellLogs::showPlot() {
