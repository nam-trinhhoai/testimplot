...
Viewport {
    ...
    readonly property QQ2.Item frame: QQ2.Rectangle {
        ...
        QQ2.Rectangle {
            ...
            height: Math.max(nameLabel.implicitHeight + 15, headerBarLoader.implicitHeight)
            QQC2.Label {
                id: nameLabel
                text: name
                anchors {
        ...
        QQ2.Rectangle {
            ...
            QQC2.ToolButton {
               ...
               // console.log("--> root3D.modeSplit3 : "+root3D.modeSplit3)
                ...
                //	var component = Qt.createComponent("ViewportGeneric.qml");
                	//var nom = "3DView "+manager.nbView3D;
    			//	var viewport =component.createObject(fgRoot, {name:nom,manager: manager, canBeMaximized: true });
          
                //	manager.addViewportMulti(0,viewport.currViewport,ViewportManager.PlaceHolder_2+manager.nbView3D,root3D.modeSplit3)// manager.maximizedViewport = (isMaximized ? null : root)
