...
StratiSliceFrequency3DLayer::StratiSliceFrequency3DLayer(StratiSliceFrequencyRep *rep, QWindow *parent, Qt3DCore::QEntity *root,
...
StratiSliceFrequency3DLayer::~StratiSliceFrequency3DLayer() {


}

void StratiSliceFrequency3DLayer::opacityChanged(float val) {
	m_opacityParameter->setValue(val);
}

void StratiSliceFrequency3DLayer::rangeChanged() {
	m_paletteRangeParameter->setValue(
			m_rep->stratiSliceAttribute()->image()->rangeRatio());
}


void StratiSliceFrequency3DLayer::updateTexture(CudaImageTexture * texture,CUDAImagePaletteHolder *img ) {
	if (texture == nullptr)
		return;
...
void StratiSliceFrequency3DLayer::update() {
	updateTexture(m_cudaTexture,m_rep->stratiSliceAttribute()->image());
	rangeChanged();
}

void StratiSliceFrequency3DLayer::updateIsoSurface() {
	updateTexture(m_cudaSurfaceTexture,m_rep->stratiSliceAttribute()->isoSurfaceHolder());
}

void StratiSliceFrequency3DLayer::updateLookupTable(const LookupTable &table) {
...
StratiSlice* StratiSliceFrequency3DLayer::stratiSlice() const {
	return m_rep->stratiSliceAttribute()->stratiSlice();
}
void StratiSliceFrequency3DLayer::show() {
...
void StratiSliceFrequency3DLayer::zScale(float val)
{
	m_transform->setScale3D(QVector3D(1, val, 1));
}

void StratiSliceFrequency3DLayer::hide() {
...
QRect3D StratiSliceFrequency3DLayer::boundingRect() const {
...
void StratiSliceFrequency3DLayer::refresh() {
