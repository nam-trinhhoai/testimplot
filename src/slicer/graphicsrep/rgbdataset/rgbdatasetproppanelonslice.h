#ifndef RGBDATASETPROPPANELONSLICE_H_
#define RGBDATASETPROPPANELONSLICE_H_
...
class RgbDatasetPropPanelOnSlice : public QWidget {
	Q_OBJECT
public:
	RgbDatasetPropPanelOnSlice(RgbDatasetRepOnSlice* rep, QWidget* parent=0);
	~RgbDatasetPropPanelOnSlice();
	void updatePalette();
