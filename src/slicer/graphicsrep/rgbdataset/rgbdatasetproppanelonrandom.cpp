...
RgbDatasetPropPanelOnRandom::RgbDatasetPropPanelOnRandom(RgbDatasetRepOnRandom* rep, QWidget* parent) : QWidget(parent) {
	m_rep = rep;
	initAllDatasets();
	...
	connect(m_redComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &RgbDatasetPropPanelOnRandom::redChangedInternal);
	connect(m_redChannelSpinBox, QOverload<int>::of(&QSpinBox::valueChanged), this, &RgbDatasetPropPanelOnRandom::redChannelChangedInternal);

	connect(m_greenComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &RgbDatasetPropPanelOnRandom::greenChangedInternal);
	connect(m_greenChannelSpinBox, QOverload<int>::of(&QSpinBox::valueChanged), this, &RgbDatasetPropPanelOnRandom::greenChannelChangedInternal);

	connect(m_blueComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &RgbDatasetPropPanelOnRandom::blueChangedInternal);
	connect(m_blueChannelSpinBox, QOverload<int>::of(&QSpinBox::valueChanged), this, &RgbDatasetPropPanelOnRandom::blueChannelChangedInternal);

	connect(m_alphaComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &RgbDatasetPropPanelOnRandom::alphaChangedInternal);
	connect(m_alphaChannelSpinBox, QOverload<int>::of(&QSpinBox::valueChanged), this, &RgbDatasetPropPanelOnRandom::alphaChannelChangedInternal);

	connect(m_constantAlphaSlider, &QSlider::valueChanged, this, &RgbDatasetPropPanelOnRandom::constantAlphaChangedInternal);
	connect(m_radiusAlphaSlider, &QSlider::valueChanged, this, &RgbDatasetPropPanelOnRandom::radiusAlphaChangedInternal);

	connect(m_seismicSurvey, &SeismicSurvey::datasetAdded, this, &RgbDatasetPropPanelOnRandom::dataAdded);
	connect(m_seismicSurvey, &SeismicSurvey::datasetRemoved, this, &RgbDatasetPropPanelOnRandom::dataRemoved);

	updateSynchroneSliders();
}

RgbDatasetPropPanelOnRandom::~RgbDatasetPropPanelOnRandom() {

}

void RgbDatasetPropPanelOnRandom::updatePalette() {
	m_redPalette->setPaletteHolder(m_rep->red());
	m_greenPalette->setPaletteHolder(m_rep->green());
	m_bluePalette->setPaletteHolder(m_rep->blue());
}

void RgbDatasetPropPanelOnRandom::redChanged() {
}

void RgbDatasetPropPanelOnRandom::greenChanged() {

}

void RgbDatasetPropPanelOnRandom::blueChanged() {

}

void RgbDatasetPropPanelOnRandom::alphaChanged() {

}

void RgbDatasetPropPanelOnRandom::constantAlphaChanged() {

}

void RgbDatasetPropPanelOnRandom::radiusAlphaChanged() {

}

void RgbDatasetPropPanelOnRandom::redChangedInternal(int index) {
	bool ok;
...
void RgbDatasetPropPanelOnRandom::greenChangedInternal(int index) {
	bool ok;
...
void RgbDatasetPropPanelOnRandom::blueChangedInternal(int index) {
	bool ok;
...
void RgbDatasetPropPanelOnRandom::alphaChangedInternal(int index) {
	bool ok;
...
void RgbDatasetPropPanelOnRandom::redChannelChangedInternal(int index) {

}

void RgbDatasetPropPanelOnRandom::greenChannelChangedInternal(int index) {

}

void RgbDatasetPropPanelOnRandom::blueChannelChangedInternal(int index) {

}

void RgbDatasetPropPanelOnRandom::alphaChannelChangedInternal(int index) {
...
void RgbDatasetPropPanelOnRandom::constantAlphaChangedInternal(int value) {
	m_rep->rgbDataset()->setConstantAlpha(value/100.0);
}

void RgbDatasetPropPanelOnRandom::radiusAlphaChangedInternal(int value) {
	m_rep->rgbDataset()->setRadiusAlpha(value/100.0 * std::sqrt(6));
}

void RgbDatasetPropPanelOnRandom::setupChannel(const QString& name, QComboBox* comboBox, QSpinBox* spinBox, QGridLayout* gridLayout, int row) {
...
void RgbDatasetPropPanelOnRandom::fillComboBox(QComboBox* comboBox) {
...
void RgbDatasetPropPanelOnRandom::initAllDatasets() {
...
void RgbDatasetPropPanelOnRandom::dataAdded(Seismic3DAbstractDataset* data) {
...
void RgbDatasetPropPanelOnRandom::dataRemoved(Seismic3DAbstractDataset* data) {
...
bool RgbDatasetPropPanelOnRandom::removeDataFromComboBox(QComboBox* comboBox, QSpinBox* spinBox, int key) {
	int index = 0;
	bool notFound = true;
...
std::size_t RgbDatasetPropPanelOnRandom::nextIndex() const {
	return m_nextIndex++;
}

void RgbDatasetPropPanelOnRandom::createlinkedSliderSpin(QWidget *parent, QSlider *slider,
...
void RgbDatasetPropPanelOnRandom::updateSynchroneSliders() {
...
void RgbDatasetPropPanelOnRandom::initSynchroneSliders() {
...
void RgbDatasetPropPanelOnRandom::setRedIndex(int value) {
	m_oldDeltaRed = m_rep->rgbDataset()->channelGreen() - value;
	m_rep->rgbDataset()->setChannelRed(value);
}

void RgbDatasetPropPanelOnRandom::setGreenIndex(int value) {
	// red
...
void RgbDatasetPropPanelOnRandom::setBlueIndex(int value) {
	m_oldDeltaBlue = value - (m_rep->rgbDataset()->channelGreen());
	m_rep->rgbDataset()->setChannelBlue(value);
}

void RgbDatasetPropPanelOnRandom::updateRGBSynchroneSliders() {
...
void RgbDatasetPropPanelOnRandom::frequencyChanged() {
...
void RgbDatasetPropPanelOnRandom::updateSpinValue(int value, QSlider *slider, QSpinBox *spin, QLineEdit* lineEdit) {
...
void RgbDatasetPropPanelOnRandom::updateSliderSpin(int min, int max, QSlider *slider,
		QSpinBox *spin) {
