...
FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::FixedRGBLayersFromDatasetAndCubePropPanelOnRandom(
		FixedRGBLayersFromDatasetAndCubeRepOnRandom *rep, QWidget *parent) : QWidget(parent) {
	m_rep = rep;
	...
	connect(m_modeComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::modeChangedInternal);
	...
	connect(m_slider, &QSlider::valueChanged, this, &FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::changeDataKeyFromSlider);
	...
	connect(m_layerNameSpinBox, &EditingSpinBox::contentUpdated, this, &FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::changeDataKeyFromSpinBox,
			Qt::QueuedConnection);
	...
	connect(m_multiplierComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::multiplierChanged);
	...
	connect(m_rep->fixedRGBLayersFromDataset(), &FixedRGBLayersFromDatasetAndCube::modeChanged, this,
			&FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::modeChanged);
	...
	connect(m_rep->fixedRGBLayersFromDataset(), &FixedRGBLayersFromDatasetAndCube::initProgressBar, this,
			&FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::initProgressBar);
	connect(m_rep->fixedRGBLayersFromDataset(), &FixedRGBLayersFromDatasetAndCube::valueProgressBarChanged, this,
			&FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::valueProgressBarChanged);
	connect(m_rep->fixedRGBLayersFromDataset(), &FixedRGBLayersFromDatasetAndCube::endProgressBar, this,
			&FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::endProgressBar);
...
void FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::changeDataKeyFromSlider(long index) {
...
void FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::changeDataKeyFromSpinBox() {
...
void FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::multiplierChanged(int index) {
	bool ok;
...
void FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::modeChangedInternal(int index) {
...
void FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::modeChanged() {
	FixedRGBLayersFromDatasetAndCube* data = m_rep->fixedRGBLayersFromDataset();
...
void FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::initProgressBar(int min, int max, int val) {
	m_progressBar->setRange(min, max);
	m_progressBar->setValue(val);
	m_progressBar->show();
}

void FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::valueProgressBarChanged(int val) {
	m_progressBar->setValue(val);
}

void FixedRGBLayersFromDatasetAndCubePropPanelOnRandom::endProgressBar() {
	m_progressBar->hide();
}
