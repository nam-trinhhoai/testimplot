#ifndef HorizonFolderRepOnSlice_H
#define HorizonFolderRepOnSlice_H
...
class HorizonFolderPropPanelOnSlice;
class HorizonFolderLayerOnSlice;
class HorizonFolderData;
class FixedRGBLayersFromDatasetAndCube;
class IGeorefImage;

class HorizonFolderRepOnSlice : public AbstractGraphicRep,  public ISliceableRep, public ISampleDependantRep {
Q_OBJECT
public:
HorizonFolderRepOnSlice(HorizonFolderData *fixedLayer, SliceDirection dir, AbstractInnerView *parent = 0);
	virtual ~HorizonFolderRepOnSlice();
...
protected:
	HorizonFolderPropPanelOnSlice *m_propPanel;
	HorizonFolderLayerOnSlice *m_layer;
