...
FixedLayersFromDatasetAndCubePropPanelOnSlice::FixedLayersFromDatasetAndCubePropPanelOnSlice(
		FixedLayersFromDatasetAndCubeRepOnSlice *rep, QWidget *parent, bool valid) : QWidget(parent) {
	if ( !valid ) return;
	m_rep = rep;
	...
	connect(m_modeComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &FixedLayersFromDatasetAndCubePropPanelOnSlice::modeChangedInternal);
	...
	connect(m_slider, &QSlider::valueChanged, this, &FixedLayersFromDatasetAndCubePropPanelOnSlice::changeDataKeyFromSlider);
	...
	connect(m_layerNameSpinBox, &EditingSpinBox::contentUpdated, this, &FixedLayersFromDatasetAndCubePropPanelOnSlice::changeDataKeyFromSpinBox,
			Qt::QueuedConnection);
	...
	connect(m_multiplierComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &FixedLayersFromDatasetAndCubePropPanelOnSlice::multiplierChanged);
	...
	connect(m_rep->fixedLayersFromDataset(), &FixedLayersFromDatasetAndCube::modeChanged, this,
			&FixedLayersFromDatasetAndCubePropPanelOnSlice::modeChanged);
	...
	connect(m_rep->fixedLayersFromDataset(), &FixedLayersFromDatasetAndCube::initProgressBar, this,
			&FixedLayersFromDatasetAndCubePropPanelOnSlice::initProgressBar);
	connect(m_rep->fixedLayersFromDataset(), &FixedLayersFromDatasetAndCube::valueProgressBarChanged, this,
			&FixedLayersFromDatasetAndCubePropPanelOnSlice::valueProgressBarChanged);
	connect(m_rep->fixedLayersFromDataset(), &FixedLayersFromDatasetAndCube::endProgressBar, this,
			&FixedLayersFromDatasetAndCubePropPanelOnSlice::endProgressBar);
...
void FixedLayersFromDatasetAndCubePropPanelOnSlice::changeDataKeyFromSlider(long index) {
...
void FixedLayersFromDatasetAndCubePropPanelOnSlice::changeDataKeyFromSpinBox() {
...
void FixedLayersFromDatasetAndCubePropPanelOnSlice::multiplierChanged(int index) {
	bool ok;
...
void FixedLayersFromDatasetAndCubePropPanelOnSlice::modeChangedInternal(int index) {
...
void FixedLayersFromDatasetAndCubePropPanelOnSlice::modeChanged() {
	FixedLayersFromDatasetAndCube* data = m_rep->fixedLayersFromDataset();
...
void FixedLayersFromDatasetAndCubePropPanelOnSlice::initProgressBar(int min, int max, int val) {
	m_progressBar->setRange(min, max);
	m_progressBar->setValue(val);
	m_progressBar->show();
}

void FixedLayersFromDatasetAndCubePropPanelOnSlice::valueProgressBarChanged(int val) {
	m_progressBar->setValue(val);
}

void FixedLayersFromDatasetAndCubePropPanelOnSlice::endProgressBar() {
	m_progressBar->hide();
}
