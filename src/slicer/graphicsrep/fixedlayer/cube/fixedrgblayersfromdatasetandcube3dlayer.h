#ifndef FixedRGBLayersFromDatasetAndCube3DLayer_H
#define FixedRGBLayersFromDatasetAndCube3DLayer_H
...
class FixedRGBLayersFromDatasetAndCube3DLayer : public Graphic3DLayer, public SurfaceCollision {
Q_OBJECT
public:
	FixedRGBLayersFromDatasetAndCube3DLayer(FixedRGBLayersFromDatasetAndCubeRep *rep, QWindow * parent,Qt3DCore::QEntity *root,Qt3DRender::QCamera * camera);
	virtual ~FixedRGBLayersFromDatasetAndCube3DLayer();
...
private:
	FixedRGBLayersFromDatasetAndCube * data() const;
