#ifndef FixedRGBLayersFromDataset3DLayer_H
#define FixedRGBLayersFromDataset3DLayer_H
...
class FixedRGBLayersFromDataset3DLayer : public Graphic3DLayer {
Q_OBJECT
public:
	FixedRGBLayersFromDataset3DLayer(FixedRGBLayersFromDatasetRep *rep, QWindow * parent,Qt3DCore::QEntity *root,Qt3DRender::QCamera * camera);
	virtual ~FixedRGBLayersFromDataset3DLayer();
...
private:
	FixedRGBLayersFromDataset * data() const;
