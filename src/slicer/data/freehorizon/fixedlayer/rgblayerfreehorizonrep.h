...
#ifndef __RGBLAYERFREEHORIZONGRAPHICREP__
#define __RGBLAYERFREEHORIZONGRAPHICREP__
...
class RGBLayerFreeHorizonRep: public AbstractGraphicRep
 {
Q_OBJECT
public:
RGBLayerFreeHorizonRep(RGBLayerSlice *stratislice, AbstractInnerView *parent = 0);
	virtual ~RGBLayerFreeHorizonRep();
