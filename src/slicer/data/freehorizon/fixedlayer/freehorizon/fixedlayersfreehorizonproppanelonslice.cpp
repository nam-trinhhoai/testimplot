...
FixedLayersFreeHorizonPropPanelOnSlice::FixedLayersFreeHorizonPropPanelOnSlice(
		FixedLayersFromDatasetAndCubeRepOnSlice *rep, QWidget *parent) :
		FixedLayersFromDatasetAndCubePropPanelOnSlice(rep, parent, false) {
	m_rep = rep;
	...
	connect(m_modeComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &FixedLayersFreeHorizonPropPanelOnSlice::modeChangedInternal);

	QWidget* holder = new QWidget;
	QVBoxLayout* formLayout = new QVBoxLayout(holder);

	QLabel* label = new QLabel("Layersxxxxxxxxxxxxxx");
	...
	connect(m_slider, &QSlider::valueChanged, this, &FixedLayersFreeHorizonPropPanelOnSlice::changeDataKeyFromSlider);
	...
	connect(m_layerNameSpinBox, &EditingSpinBox::contentUpdated, this, &FixedLayersFreeHorizonPropPanelOnSlice::changeDataKeyFromSpinBox,
			Qt::QueuedConnection);
	...
	connect(m_multiplierComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &FixedLayersFreeHorizonPropPanelOnSlice::multiplierChanged);
	...
	connect(m_rep->fixedLayersFromDataset(), &FixedLayersFromDatasetAndCube::modeChanged, this,
			&FixedLayersFreeHorizonPropPanelOnSlice::modeChanged);
...
void FixedLayersFreeHorizonPropPanelOnSlice::changeDataKeyFromSlider(long index) {
...
void FixedLayersFreeHorizonPropPanelOnSlice::changeDataKeyFromSpinBox() {
...
void FixedLayersFreeHorizonPropPanelOnSlice::multiplierChanged(int index) {
	bool ok;
...
void FixedLayersFreeHorizonPropPanelOnSlice::modeChangedInternal(int index) {
...
void FixedLayersFreeHorizonPropPanelOnSlice::modeChanged() {
	FixedLayersFromDatasetAndCube* data = m_rep->fixedLayersFromDataset();
...
void FixedLayersFreeHorizonPropPanelOnSlice::initProgressBar(int min, int max, int val) {
	m_progressBar->setRange(min, max);
	m_progressBar->setValue(val);
	m_progressBar->show();
}

void FixedLayersFreeHorizonPropPanelOnSlice::valueProgressBarChanged(int val) {
	m_progressBar->setValue(val);
}

void FixedLayersFreeHorizonPropPanelOnSlice::endProgressBar() {
	m_progressBar->hide();
}
