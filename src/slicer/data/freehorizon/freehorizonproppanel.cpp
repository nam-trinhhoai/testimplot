...
FreeHorizonPropPanel::FreeHorizonPropPanel(FreeHorizonAttributRepOnSlice *rep,
...
/*
	...
	connect(m_rep->fixedLayer(), &FreeHorizonAttributLayer::newPropertyCreated, this, &FixedLayerFromDatasetPropPanel::addNewItemToComboBoxList);
	 * */
}

FreeHorizonPropPanel::~FreeHorizonPropPanel() {

}

void FreeHorizonPropPanel::updatePalette() {
	// m_palette->setPaletteHolder(m_rep->image());
}

void FreeHorizonPropPanel::layerChanged(QString value) {
	// m_rep->chooseAttribute(value);
}

void FreeHorizonPropPanel::showCrossHair(int value) {
	// m_rep->showCrossHair(value == Qt::Checked);
}

void FreeHorizonPropPanel::pick() {
	/*
...
void FreeHorizonPropPanel::updateComboValue(QString value) {
	/*
...
void FreeHorizonPropPanel::addNewItemToComboBoxList(QString item) {
