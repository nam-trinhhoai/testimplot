#ifndef RgbComputationOnDataset_H_
#define RgbComputationOnDataset_H_
...
class RgbComputationOnDatasetGraphicRepFactory;

class RgbComputationOnDataset : public Volume {
	Q_OBJECT
public:
	RgbComputationOnDataset(Seismic3DAbstractDataset* dataset, int channel, WorkingSetManager *workingSet, QObject *parent=nullptr);
	~RgbComputationOnDataset();
...
private:
	...
	RgbComputationOnDatasetGraphicRepFactory * m_repFactory;
};
