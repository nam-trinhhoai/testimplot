#ifndef SRC_INFORMATIONMANAGER_ISOHORIZON_ISOHORIZONINFORMATION_H
#define SRC_INFORMATIONMANAGER_ISOHORIZON_ISOHORIZONINFORMATION_H
...
class IsoHorizonInformation : public IInformation, public IInformationFolder {
	Q_OBJECT
public:
	IsoHorizonInformation(const QString& name, const QString& fullPath, WorkingSetManager* manager, QObject* parent=0);
	virtual ~IsoHorizonInformation();
	...
	virtual QString getNbreDirectories();
...
private:
	...
	mutable IsoHorizon* m_loadedData = nullptr;
