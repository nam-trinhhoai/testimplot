...
IsoHorizonInformationMetadataWidget::IsoHorizonInformationMetadataWidget(IInformation* information, QWidget* parent) :
	...
	if (m_hasFolder) {
		...
		connect(m_openButton, &QPushButton::clicked, this, &IsoHorizonInformationMetadataWidget::openDir);
	} else {
		m_openButton = nullptr;
	}
}

IsoHorizonInformationMetadataWidget::~IsoHorizonInformationMetadataWidget() {

}

void IsoHorizonInformationMetadataWidget::openDir() {
	if (!m_hasFolder) {
		return;
	}
