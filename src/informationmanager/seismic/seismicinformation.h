#ifndef SRC_INFORMATIONMANAGER_SEISMIC_SEISMICINFORMATION_H
#define SRC_INFORMATIONMANAGER_SEISMIC_SEISMICINFORMATION_H
...
class SeismicInformation : public IInformation, public IInformationFolder {
	Q_OBJECT
public:
	SeismicInformation(const QString& name, const QString& fullPath, WorkingSetManager* manager, bool enableToggleAction = true, QObject* parent=0);
	virtual ~SeismicInformation();
