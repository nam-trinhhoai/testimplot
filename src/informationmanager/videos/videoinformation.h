#ifndef SRC_INFORMATIONMANAGER_VIDEOS_VIDEOINFORMATION_H
#define SRC_INFORMATIONMANAGER_VIDEOS_VIDEOINFORMATION_H
...
class VideoInformation : public IInformation, public IInformationFolder {
	Q_OBJECT
public:
	VideoInformation(const QString& name, const QString& aviPath, QObject* parent=0);
	virtual ~VideoInformation();
...
#endif // SRC_INFORMATIONMANAGER_VIDEOS_VIDEOINFORMATION_H
