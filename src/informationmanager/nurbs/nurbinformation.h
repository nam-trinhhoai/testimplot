#ifndef SRC_INFORMATIONMANAGER_NURBS_NURBINFORMATION_H
#define SRC_INFORMATIONMANAGER_NURBS_NURBINFORMATION_H
...
class NurbInformation : public IInformation, public IInformationFolder {
	Q_OBJECT
public:
	NurbInformation(const QString& name, const QString& fullPath, WorkingSetManager* manager, QObject* parent=0);
	virtual ~NurbInformation();
